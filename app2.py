...
class App:
    ...
    def show_profile(self):
        def update_profile(account_id, first_name, last_name, username, password, email, datas_before):
            ...
            del self.accounts[datas_before[2]]
        ...
        datas_before = [ self.curr_account.first_name, self.curr_account.last_name, self.curr_account.username, self.curr_account.password, self.curr_account.email,self.curr_account.account_id]
    ...
    def show_terms_conditions(self):
        ...
        icon_image = get_image(rf"PROJECT/imgs/Orquesta sinfónica.jpeg", 500, 350)
    ...
    def show_about_us(self):
        ...
        icon_image = get_image(rf"PROJECT/imgs/National Symphony Orchestra.jpeg", 500, 350)
    ...
    def show_contacts(self):
        ...
        icon_image = get_image(rf"PROJECT/imgs/conductor1.jpeg", 200, 200)
        ...
        icon_image = get_image(rf"PROJECT/imgs/conductor2.jpeg", 200, 200)
        ...
        icon_image = get_image(rf"PROJECT/imgs/soloist1.jpeg", 200, 200)

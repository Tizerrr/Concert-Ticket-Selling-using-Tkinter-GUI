    ...
    def connect_SQL(self):
        try:
            ...
            if self.conn.is_connected():
                ...
                self.cursor.execute("DROP DATABASE events_db")
                ...
                if self.not_created():
                    ...
                    self.cursor.execute("""
                        ...
                        account_id VARCHAR(200) NOT NULL PRIMARY KEY,
                    ...
                    # symphony, concerto,orchestral , chamber, choral, ballet, themed
                    self.cursor.execute(rf"""
